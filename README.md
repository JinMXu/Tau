...
> 参考 [Ousia](https://github.com/s1dashu/ousia) 设计的 Pi Coding Agent 桌面客户端，基于 Tauri 2 + React 19。

Tau（τ = 2π）是 [Pi Coding Agent](https://github.com/earendil-works/pi) 的极简桌面客户端——π 只画了半个圆，Tau 把它补成完整的桌面体验。它用干净的原生窗口包裹 Pi，提供项目化会话、流式 Markdown、持久化历史与多窗口体验，让你在不离开代码库的情况下持续推进对话。
