...
export interface MessageScrollerProps extends ComponentPropsWithRef<"div"> {
  ...
  /** Which edge the navigation rail hugs (vendored extension; upstream pins
   *  the rail to the right). "left" flips the rail, tick alignment, preview
   *  card side and the overflow gutter together. */
  railSide?: "left" | "right";
    ...
    >
      {navigation === "rail" ? (
        <PreviewRail
          ...
          previewSide={railSide === "left" ? "after" : "before"}
          highlightActive
          itemSize={14}
          className="h-full min-h-0 overflow-hidden"
          previewContainerClassName={
            railSide === "left" ? "left-8 right-3" : "right-8 left-3"
          }
          previewClassName={
            railSide === "left"
